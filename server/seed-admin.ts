    ...
    await db.insert(news).values([
      {
        ...
        contentTj: "Корхонаи давлатии заводи протезию ортопедии шаҳри Душанбе бо дастгирии Вазорати тандурустӣ ва ҳифзи иҷтимоии аҳолии Ҷумҳурии Тоҷикистон таҷҳизоти навро дар сексияи протезӣ насб кард. Ин таҷҳизот имконият медиҳад, ки протезҳои сифатнок ва муосир истеҳсол карда шаванд.",
        contentRu: "Государственное предприятие протезно-ортопедический завод города Душанбе при поддержке Министерства здравоохранения и социальной защиты населения Республики Таджикистан установило новое оборудование в протезном цехе. Это оборудование позволяет производить качественные и современные протезы.",
        contentEn: "The State Enterprise Prosthetic and Orthopedic Plant of Dushanbe city, with the support of the Ministry of Health and Social Protection of the Republic of Tajikistan, installed new equipment in the prosthetics workshop. This equipment allows the production of high-quality and modern prosthetics.",
